...
if product == 'pdns_recursor':
	args = ['--disable-syslog']
	apiconffile = '/etc/powerdns/recursor.d/api.conf'
...
"""
	...
	args = ['--disable-syslog']
	apiconffile = '/etc/powerdns/conf.d/api.conf'
	apienvvar = 'PDNS_SERVER_API_KEY'
	apiconftemplate = """webserver
api-key={apikey}
webserver-address=0.0.0.0
webserver-allow-from=0.0.0.0/0
...
"""
	...
	apiconffile = '/etc/dnsdist/conf.d/api.conf'
	apienvvar = 'DNSDIST_API_KEY'
	apiconftemplate = """webserver("0.0.0.0:8083", '{apikey}', '{apikey}')
